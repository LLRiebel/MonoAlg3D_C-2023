if (is_paci == 0) {
    ...
    //Model available at: https://github.com/jtmff/torord/blob/master/matlab/model_Torord_dynCl.m and https://github.com/rsachetto/MonoAlg3D_C/tree/master/src/models_library/ToROrd
    //
    ...
    //     Adapted to MonoAlg3D by Leto Riebel, February 2022
    //
    //     This model combines:
    ...
    //
    //     layer: 1=endocardial, 2=midmyocardial, 3=epicardial
    ...
    //Current
    real GKs = 0.0011 * (pow(0.2, (2*apicobasal - 1))) * IKs_mult; //Apicobasal gradient normalised to produce scaling factor between 0.2 and 5.0
    if(layer == 3) {
        GKs = GKs*1.4;
    }
    if(infarct_zone == 0) {
