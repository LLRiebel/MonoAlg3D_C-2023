...
SET_ODE_INITIAL_CONDITIONS_CPU(set_model_initial_conditions_cpu) {
    ...
    log_info("Using Paci_ToRORd_dynCl_PhiCaL_IKCa_mixed_apicobasal_infarctionRemod CPU model. If you want to use the stem cell model, please edit the .common file\n");
...
void RHS_cpu(real *a_, real *b_, const real *sv, real *rDY, real stim_current, real dt, int is_paci, int layer, int infarct_zone, int infarct_stage, real apicobasal, real *current_scaling) {
    ...
    //Applied globally, e.g. because of drug application
